...
Invoke-WebRequest -Uri https://raw.githubusercontent.com/TheNadav/Sysmon/main/sysmon-conf.xml -Outfile sysmon-conf.xml

Write-Host "Configuration File Retrieved"

Write-Host "Installing Sysmon"

.\sysmon64.exe -accepteula -i sysmon-conf.xml
